    ...
    <div className="mb-[35px] flex flex-col-reverse justify-between gap-6 md:flex-row">
      ...
      <div className="hidden sm:flex flex-row justify-end gap-2">
         ...
         <CustomButton
          ...
          styles="bg-[#8c6dfd]" // You can customize the styles as needed
          handleClick={() => {
            window.open("http://localhost:5175/", "_blank"); // Opens in a new tab
          }}
        />
{/* 
        <CustomButton
          btnType="button"
          title="Hygieia Encyclopedia"
          styles="bg-[#8c6dfd]" // You can customize the styles as needed
          handleClick={() => {
            window.open("http://localhost:5177/", "_blank"); // Opens in a new tab
          }}
        /> */}
        ...
        <CustomButton
          ...
          styles="bg-[#8c6dfd]" // You can customize the styles as needed
          handleClick={() => {
            window.open("http://localhost:8501/", "_blank"); // Opens in a new tab
          }}
        />
        ...
        <CustomButton
          ...
          styles="bg-[#8c6dfd]" // You can customize the styles as needed
          handleClick={() => {
            window.open("http://localhost:3000/", "_blank"); // Opens in a new tab
          }}
        />
